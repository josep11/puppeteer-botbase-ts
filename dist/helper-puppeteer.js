...
class HelperPuppeteer {
     ...
     */
    static closePopupByTextContaining(page_1) {
        return __awaiter(this, arguments, void 0, function* (page, textElementOrChildren = "Aceptar y cerrar", elementType = "*") {
     ...
     * @returns {Promise<boolean>} true if the element was clicked, false otherwise
     */
    static closePopup(page_1) {
        return __awaiter(this, arguments, void 0, function* (page, elementText = "Aceptar y cerrar", elementType = "*") {
     ...
     */
    static tryToClickElementByTextOrCssSelectors(page_1) {
        return __awaiter(this, arguments, void 0, function* (page, elementText = null, cssSelectorArray = []) {
            if (elementText &&
     ...
     */
    static isTextPresentOnWebpage(page_1, text_1) {
        return __awaiter(this, arguments, void 0, function* (page, text, ignoreCase = true) {
