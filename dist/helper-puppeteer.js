...
class HelperPuppeteer {
     ...
     */
    static async closePopupByTextContaining(page, textElementOrChildren = "Aceptar y cerrar", elementType = "*") {
     ...
     * @returns {Promise<boolean>} true if the element was clicked, false otherwise
     */
    static async closePopup(page, elementText = "Aceptar y cerrar", elementType = "*") {
     ...
     */
    static async tryToClickElementByTextOrCssSelectors(page, elementText = null, cssSelectorArray = []) {
        if (elementText &&
    ...
    static async countStringOccurrencesInPage(page, textToFind) {
        ...
        return await page.$eval("body", (el, textSearch) => {
    ...
    static async dumpPageContentToFile(page, filename) {
        ...
        await index_1.helper.writeFile(filename, content);
    }
    /**
     * @param {Page} page
